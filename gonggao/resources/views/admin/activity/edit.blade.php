...
<div class="page-container">
    <div class="row cl" style="margin: 0 0 10px 0">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="{{$activity->name}}" placeholder="请输入活动名称" id="name" name="name">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动费用：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="number" class="input-text" value="{{$activity->money}}" placeholder="请输入活动费用" id="money" name="money">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动虚拟人数：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="number" class="input-text" value="{{$activity->num}}" placeholder="请输入活动实际人数" id="num1" name="num1">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动限制人数：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="number" class="input-text" value="{{$activity->limit}}" placeholder="请输入活动限制人数" id="limit" name="limit">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动积分：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="number" class="input-text" value="{{$activity->point}}" placeholder="请输入活动积分" id="point" name="point">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="text" class="input-text" name="start_time" value="{{$activity->start_time}}" id="test5" placeholder="请选择日期和时间">
                </div>
            </div>
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="text" class="input-text" name="end_time" value="{{$activity->end_time}}" id="end_time" placeholder="请选择日期和时间">
                </div>
            </div>
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="{{$activity->start_location}}" placeholder="请输入活动开始地点" id="start_location" name="start_location">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动结束地点：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="{{$activity->end_location}}" placeholder="请输入活动结束地点" id="end_location" name="end_location">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动介绍：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <textarea name="arrange" id="editor" cols="100" rows="8" style="visibility:hidden;">
                {!! $activity->arrange !!}
            </textarea>
        </div>
    </div>
