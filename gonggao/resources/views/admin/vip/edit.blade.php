...
<div class="page-container">
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>会员费用：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="number" class="input-text" value="{{$vip->num}}" placeholder="请输入会员费用" id="num" name="num">
        </div>
    </div>
    <input type="hidden" value="{{$vip->id}}" id="vip_id">
