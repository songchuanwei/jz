...
<div class="page-container">
    <div class="row cl" style="margin: 0 0 10px 0">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="{{$course->name}}" placeholder="请输入公开课名称" id="name" name="name">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>老师名称：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="{{$course->teacher}}" placeholder="请输入老师名称" id="teacher" name="teacher">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
    ...
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>公开课虚拟人数：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="number" class="input-text" value="{{$course->num1}}" placeholder="请输入公开课虚拟人数" id="num1" name="num1">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>公开课限制人数：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="number" class="input-text" value="{{$course->limit}}" placeholder="请输入公开课限制人数" id="limit" name="limit">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>公开课积分：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="number" class="input-text" value="{{$course->point}}" placeholder="请输入公开课积分" id="point" name="point">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="text" class="input-text" name="time" id="time" value="{{$course->time}}" placeholder="请选择日期和时间(选填)">
                </div>
            </div>
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="{{$course->location}}" placeholder="请输入公开课开始地点(选填)" id="location" name="location">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
    ...
    <div class="row cl" style="margin: 0 0 10px 0">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <img src="{{$course->photo}}" class="radius" width="50px" height="50px">&nbsp;&nbsp;&nbsp;&nbsp;不选为不修改
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>公开课介绍：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <textarea cols="" rows="" class="textarea" name="content" id="content" placeholder="说点什么...最少输入10个字符">{{$course->content}}</textarea>
    ...
    <div class="row cl" style="margin: 0 0 10px 0">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <textarea cols="" rows="" class="textarea" name="teacher_info" id="teacher_info" placeholder="说点什么...最少输入10个字符">{{$course->teacher_info}}</textarea>
            <p class="textarea-numberbar"><em class="textarea-length"></em>500</p>
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
...
<script language="javascript" type="text/javascript">
    ...
    function Check() {
        ...
        formData.append("status",$('input:radio:checked').val());
        formData.append("teacher_info",$("#teacher_info").val());
        $.ajax({
            type: 'post',
            url: '/admin_course/edit',
            data: formData,
            dataType: 'json',
            contentType: false,
            processData: false,
