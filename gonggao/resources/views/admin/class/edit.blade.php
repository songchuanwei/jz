...
<div class="page-container">
    <div class="row cl" style="margin: 0 0 10px 0">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="{{$class->name}}" placeholder="请输入学校名称" id="name" name="name">
        </div>
    </div>
    <div class="row cl" style="margin: 0 0 10px 0">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>学校编号：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="number" class="input-text" value="{{$class->num}}" placeholder="请输入学校编号" id="num" name="num">
        </div>
    </div>
    <input type="hidden" value="{{$class->id}}" id="class_id">
